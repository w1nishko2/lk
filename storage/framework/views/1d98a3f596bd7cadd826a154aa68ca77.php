                    ...
                    <div class="card bg-primary text-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h4 id="total-count"><?php echo e($stats['total']); ?></h4>
                ...
                <div class="col-md-3">
                    <div class="card bg-warning text-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h4 id="pending-count"><?php echo e($stats['pending']); ?></h4>
                ...
                <div class="col-md-3">
                    <div class="card bg-success text-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h4 id="sent-count"><?php echo e($stats['sent']); ?></h4>
                ...
                <div class="col-md-3">
                    <div class="card bg-danger text-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h4 id="failed-count"><?php echo e($stats['failed']); ?></h4>
                ...
                <div class="card-body">
                    ...
                    <div class="progress" style="height: 25px;">
                        <div class="progress-bar bg-success" role="progressbar" 
                             style="width: <?php echo e($stats['total'] > 0 ? round(($stats['sent'] / $stats['total']) * 100, 2) : 0); ?>%"
                             id="progress-bar">
                            <span id="progress-text">
                                <?php echo e($stats['total'] > 0 ? round(($stats['sent'] / $stats['total']) * 100, 2) : 0); ?>%
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        <code>*/1 * * * * cd <?php echo e(base_path()); ?> && php artisan email:send-mass --send --batch=5</code>
                    </div>
                    <p class="text-muted">
                    ...
                    <div class="alert alert-secondary">
                        <code>* * * * * cd <?php echo e(base_path()); ?> && php artisan email:send-mass --send --batch=5</code><br>
                        <code>* * * * * sleep 15 && cd <?php echo e(base_path()); ?> && php artisan email:send-mass --send --batch=5</code><br>
                        <code>* * * * * sleep 30 && cd <?php echo e(base_path()); ?> && php artisan email:send-mass --send --batch=5</code><br>
                        <code>* * * * * sleep 45 && cd <?php echo e(base_path()); ?> && php artisan email:send-mass --send --batch=5</code>
                    </div>
                    <a href="<?php echo e(route('mass-email.template')); ?>" class="btn btn-outline-info" target="_blank">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php if($recentSent->count() > 0): ?>
                                <div class="list-group">
                                    <?php $__currentLoopData = $recentSent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $email): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="list-group-item d-flex justify-content-between align-items-center">
                                            <span><?php echo e($email->email); ?></span>
                                            <small class="text-muted"><?php echo e($email->sent_at->diffForHumans()); ?></small>
                                        </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php if($recentFailed->count() > 0): ?>
                                <div class="list-group">
                                    <?php $__currentLoopData = $recentFailed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $email): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="list-group-item">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <span><?php echo e($email->email); ?></span>
                                                <small class="text-muted">Попыток: <?php echo e($email->attempts); ?></small>
                                            </div>
                                            <?php if($email->error_message): ?>
                                                <small class="text-danger"><?php echo e(Str::limit($email->error_message, 100)); ?></small>
                                            <?php endif; ?>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
...
function importEmails() {
    ...
    $.post('<?php echo e(route("mass-email.import")); ?>', {
...
function sendBatch() {
    ...
    $.post('<?php echo e(route("mass-email.send-batch")); ?>', {
        _token: '<?php echo e(csrf_token()); ?>',
...
function resetFailed() {
    ...
    $.post('<?php echo e(route("mass-email.reset-failed")); ?>', {
        _token: '<?php echo e(csrf_token()); ?>'
    })
    .done(function(response) {
        hideLoading();
...
function clearQueue() {
    ...
    $.post('<?php echo e(route("mass-email.clear")); ?>', {
        _token: '<?php echo e(csrf_token()); ?>'
    })
    .done(function(response) {
        hideLoading();
...
function refreshStats() {
    $.get('<?php echo e(route("mass-email.stats")); ?>')
    .done(function(stats) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\konstructor\resources\views/mass-email/index.blade.php ENDPATH**/ ?>