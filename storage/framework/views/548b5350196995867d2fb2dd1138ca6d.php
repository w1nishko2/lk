    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>Редактирование блока: <?php echo e($block->name); ?></h2>
                <div>
            ...
            <form method="POST" action="<?php echo e(route('blocks.update', $block)); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            <option value="header" <?php echo e(old('type', $block->type) == 'header' ? 'selected' : ''); ?>>Header (Шапка)</option>
                                            <option value="hero" <?php echo e(old('type', $block->type) == 'hero' ? 'selected' : ''); ?>>Hero (Главный баннер)</option>
                                            <option value="features" <?php echo e(old('type', $block->type) == 'features' ? 'selected' : ''); ?>>Features (Возможности)</option>
                                            <option value="services" <?php echo e(old('type', $block->type) == 'services' ? 'selected' : ''); ?>>Services (Услуги)</option>
                                            <option value="about" <?php echo e(old('type', $block->type) == 'about' ? 'selected' : ''); ?>>About (О нас)</option>
                                            <option value="contact" <?php echo e(old('type', $block->type) == 'contact' ? 'selected' : ''); ?>>Contact (Контакты)</option>
                                            <option value="cta" <?php echo e(old('type', $block->type) == 'cta' ? 'selected' : ''); ?>>CTA (Призыв к действию)</option>
                                            <option value="footer" <?php echo e(old('type', $block->type) == 'footer' ? 'selected' : ''); ?>>Footer (Подвал)</option>
                                            <option value="content" <?php echo e(old('type', $block->type) == 'content' ? 'selected' : ''); ?>>Content (Контент)</option>
                                            <option value="gallery" <?php echo e(old('type', $block->type) == 'gallery' ? 'selected' : ''); ?>>Gallery (Галерея)</option>
                                            <option value="testimonials" <?php echo e(old('type', $block->type) == 'testimonials' ? 'selected' : ''); ?>>Testimonials (Отзывы)</option>
                                            <option value="pricing" <?php echo e(old('type', $block->type) == 'pricing' ? 'selected' : ''); ?>>Pricing (Цены)</option>
                                            <option value="team" <?php echo e(old('type', $block->type) == 'team' ? 'selected' : ''); ?>>Team (Команда)</option>
                                            <option value="blog" <?php echo e(old('type', $block->type) == 'blog' ? 'selected' : ''); ?>>Blog (Блог)</option>
                                            <option value="other" <?php echo e(old('type', $block->type) == 'other' ? 'selected' : ''); ?>>Other (Другое)</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>" 
                                                ...
                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($category); ?>" <?php echo e(old('category', $block->category) == $category ? 'selected' : ''); ?>>
                                                        <?php echo e($category); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                               id="category" 
                                               name="category" 
                                               value="<?php echo e(old('category', $block->category)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                               id="sort_order" 
                                               name="sort_order" 
                                               value="<?php echo e(old('sort_order', $block->sort_order)); ?>" 
                                               min="0">
...
unset($__errorArgs, $__bag); ?>" 
                                              id="description" 
                                              name="description" 
                                              rows="3"><?php echo e(old('description', $block->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          name="html_content" 
                                          rows="15" 
                                          required><?php echo e(old('html_content', $block->html_content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                          id="css_content" 
                                          name="css_content" 
                                          rows="10"><?php echo e(old('css_content', $block->css_content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                          id="js_content" 
                                          name="js_content" 
                                          rows="8"><?php echo e(old('js_content', $block->js_content)); ?></textarea>
                            ...
                            <div class="card-body">
                                <div class="form-check">
                                    <input class="form-check-input" 
                                           ...
                                           id="is_active" 
                                           name="is_active" 
                                           <?php echo e(old('is_active', $block->is_active) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\konstructor\resources\views\blocks\edit.blade.php ENDPATH**/ ?>