            ...
            <form id="site-builder-form">
                ...
                <div class="card mb-3 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="template-option mb-2 p-2 border rounded" data-template="<?php echo e($template->id); ?>">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="template_id" 
                                       id="template_<?php echo e($template->id); ?>" value="<?php echo e($template->id); ?>" required>
                                <label class="form-check-label w-100" for="template_<?php echo e($template->id); ?>">
                                    <strong><?php echo e($template->name); ?></strong>
                                    <?php if($template->description): ?>
                                    <br><small class="text-muted"><?php echo e($template->description); ?></small>
                                    <?php endif; ?>
                                </label>
                            </div>
                        </div>
                ...
                <div class="card mb-3 shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row g-2">
                            <?php $__currentLoopData = $blocksByCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $blocks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-12">
                                <button type="button" class="btn btn-outline-primary w-100 d-flex justify-content-between align-items-center category-btn" 
                                    ...
                                    <span>
                                        <i class="fas fa-cube me-2"></i><?php echo e($category); ?>

                                    </span>
                                    <span class="badge bg-primary"><?php echo e($blocks->count()); ?></span>
                                </button>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
$(document).ready(function() {
    ...
    const blocksByCategory = <?php echo json_encode($blocksByCategory, 15, 512) ?>;
    ...
    function generatePreview() {
        ...
        $.ajax({
            url: '<?php echo e(route("site-builder.preview")); ?>',
            method: 'POST',
            data: {
    ...
    $('#site-builder-form').submit(function(e) {
        ...
        $.ajax({
            url: '<?php echo e(route("site-builder.build")); ?>',
            method: 'POST',
            data: formData,
            success: function(response) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\konstructor\resources\views\site-builder\index.blade.php ENDPATH**/ ?>